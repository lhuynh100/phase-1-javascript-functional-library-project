...
//  a collection function of an object or an array
// standardizeInput is a helper function to use wit hteh function that need to
// work with iether objects or array
...
// contains the values of the object's's properties
...
//  It takes each elemt of the input array (whether it's primitive value or an array)
// and pushes it into the output array
...
const myFlatten = function(collect, shallow, newArr=[]) {
  if (shallow) {
